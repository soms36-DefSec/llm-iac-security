...
class OpenSearchSettings(BaseModel):
    ...
    index: str = Field(default_factory=lambda: os.getenv("OPENSEARCH_INDEX", "iac-security-kb"))
    username: Optional[str] = Field(default_factory=lambda: os.getenv("OPENSEARCH_USERNAME"))
